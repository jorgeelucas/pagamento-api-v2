...
public class PagamentoController {
    ...
    @PatchMapping("/{id}")
    public Mono<Pagamento> atualizarStatus(@PathVariable("id") String id) {
        return Mono.defer(() -> service.concluir(id))
                .doOnNext(__ -> log.info("Pagamento {} concluido com sucesso", id));
    }
